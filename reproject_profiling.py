...
def main():
    processes = [False,1,2,True]
    reproj_funcs = [reproject_interp]
    block_sizes = [500]
    results = []
    ...
    for func in reproj_funcs:
        ...
        for num_p in processes:
            for bsize in block_sizes:
                ...
                if np.allclose(reference_reprojection, r):
                    print("reference and blocked match!")
    ...
    results_file = open("profiling_results.json", 'w+')
